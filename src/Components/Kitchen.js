  ...
  return (
    <div>
      ...
      <div className='container'>
        <br></br>
        <h1 className='text-center' style={{ fontSize: '28px', color: '#84cdee', fontWeight: 'bold' }}><font style={{ color: "black" }}>L</font>AMPS & LIGHTINGS</h1>
        <br></br>
        <div className='row gy-5 p-3' style={{width : '1500px', rowGap : '30px'}}>
          {Array.isArray(setFurniture) && setFurniture.map((formData) => (
