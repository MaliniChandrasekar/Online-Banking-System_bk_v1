...
const AboutUs = () => {
  return (
    <div>
      ...
      <br></br>  <br></br><div className='text-center' style={{fontSize : '28px', color: '#84cdee', fontWeight:'bold'}}><font style={{color : "black"}}>A</font>BOUT US</div>
       <br></br> <center>
...
In the last decade, Creative Home has disrupted the tenets of classical retail by combining an online virtual catalogue, an extensive in-house supply chain, and a large omnichannel footprint covering more than 100 cities in India. Life can be a ‘bed of roses’ (if the bed is from Creative Home).
        ...
        <div className='container' >
            <br></br>
        <div className='text-center'style={{fontSize : '28px', color: '#84cdee', fontWeight:'bold'}}><font style={{color : "black"}}>O</font>UR BELIEFS</div>
        <br></br>
        <div className='row'>
            <div className='col'>
