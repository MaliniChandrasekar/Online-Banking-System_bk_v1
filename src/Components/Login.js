...
const navigate=useNavigate();
        ...
        .then((res)=>{
          ...
          if(res.data == !formData.email && res.data == !formData.password){
                 ...
                 if(res.data.role=='Admin'){
                  //admin page
                  navigate('/admin', { data: 'Hello from the source page!' });
                 }else{
                  //user  page
                  navigate("/home")
                 }
  ...
  return (
    <div style={bg}>
        ...
        <form className=' m-2 text-center' onSubmit={handleSubmit} style={content}>
  ...
  <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8m8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1"/>
            ...
            <p  style={m1}>Don't you have an account? : <Link to="/signup">SignUp</Link></p>
             <button>Login</button>
        </form>
        </div>
        </div>
